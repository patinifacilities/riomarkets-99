...
export function Footer() {
  ...
  return (
    <footer className="mt-16 border-t border-border bg-secondary-glass">
      <div className="mx-auto w-full max-w-7xl px-4 py-10 md:px-6">
        ...
        <div className="grid gap-10 md:grid-cols-4">
          ...
          <div className="space-y-3">
            ...
            <Link 
              to="/faq#regulatorio"
              className="inline-flex items-center text-sm text-primary hover:underline focus:outline-none focus-visible:ring-2 focus-visible:ring-primary rounded transition-colors"
            >

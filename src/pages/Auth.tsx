                        ...
                        <div className="grid grid-cols-3 gap-2">
                          <Button
                            ...
                            onClick={async () => {
                              ...
                              if (error) toast({ title: 'Erro', description: 'Erro ao conectar com Google', variant: 'destructive' });
                            }}
                            disabled={loading}
                            className="w-full"
                          >
                          ...
                          <Button
                            ...
                            onClick={async () => {
                              ...
                              if (error) toast({ title: 'Erro', description: 'Erro ao conectar com Apple', variant: 'destructive' });
                            }}
                            disabled={loading}
                            className="w-full"
                          >
                          ...
                          <Button
                            ...
                            onClick={async () => {
                              ...
                              if (error) toast({ title: 'Erro', description: 'Erro ao conectar com Twitch', variant: 'destructive' });
                            }}
                            disabled={loading}
                            className="w-full"
                          >

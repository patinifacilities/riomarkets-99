...
export default function Rewards() {
  ...
  return (
    <div className="min-h-[100dvh] flex items-center justify-center bg-gradient-to-b from-background via-background to-primary/5 px-4 py-2 md:py-8 pb-20 md:pb-32">

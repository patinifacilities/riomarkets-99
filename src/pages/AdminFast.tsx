          ...
          <div className="flex flex-col md:flex-row items-center md:items-start justify-between mb-8 gap-4">
            ...
            <div className="flex items-center gap-4 bg-card/50 px-6 py-3 rounded-xl border border-border">
              ...
              <div className="flex items-center gap-2 justify-center w-full md:w-auto">
                <Button onClick={() => navigate('/admin/fast/api-config')} variant="outline" className="gap-2 flex-1 md:flex-initial bg-white text-gray-700 hover:bg-gray-50 border-gray-300">
                ...
                <Button onClick={() => navigate('/admin/fast/algorithm')} className="gap-2 bg-[#ff2389] hover:bg-[#ff2389]/90 text-white flex-1 md:flex-initial">
                  <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path d="M12 7 L15 12 L12 17 L9 12 Z" fill="currentColor"/>

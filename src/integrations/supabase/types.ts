  ...
  public: {
    Tables: {
      ...
      fast_pool_bets: {
        ...
        Relationships: [
          {
            foreignKeyName: "fast_pool_bets_pool_id_fkey"
            columns: ["pool_id"]
            isOneToOne: false
            referencedRelation: "fast_pools"
      ...
      fast_pool_results: {
        Row: {
          ...
          result: string
          total_bets_desceu: number | null
          total_bets_subiu: number | null
        ...
        Relationships: [
          {
            foreignKeyName: "fast_pool_results_pool_id_fkey"
            columns: ["pool_id"]
            isOneToOne: false
            referencedRelation: "fast_pools"
            referencedColumns: ["id"]
